/**
 * DeleteUserModal - Admin account deletion modal
 *
 * Renders a trigger button + modal dialog for admins to permanently
 * delete another user's account. Requires typing "DELETE ACCOUNT" to confirm.
 * Calls POST /api/admin/users/{userId}/delete on confirmation.
 */
...
export function DeleteUserModal({ userId, userName }: DeleteUserModalProps) {
  ...
  const handleConfirm = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        const body: { confirm: string; note?: string } = { confirm: CONFIRMATION_TEXT };
        if (adminNote.trim()) {
    ...
    [isConfirmed, isDeleting, userId, adminNote]
  );
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  Admin action — permanent and irreversible
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleConfirm}>
              <div style={{ padding: "1.5rem" }}>
                ...
                >
                  ...
                  >
                    <li>Their profile, email, and login will be permanently removed</li>
                    <li>All their content will be reassigned to <strong>[deleted]</strong></li>
                    <li>All API tokens and sessions will be revoked</li>
                  </ul>
                </div>
                ...
                <div style={{ marginBottom: "1.25rem" }}>
                  ...
                  <textarea
                    ...
                    disabled={isDeleting}
                    placeholder="Optionally explain why this account is being deleted..."
                  ...
                  <div
                    style={{
                      ...
                      fontSize: "var(--fs-xs)",
                      color:
                        adminNote.length >= NOTE_MAX_LENGTH
                          ? "var(--color-danger)"
